...
#
#IX - PARTIE VERIFICATION FINALE IA
...
def IniListeCaseGrille2():
    ...
    for c in range (20):
       ...
       while l <= 20:
           Case = [(x, y), b, v]  #Forme de la "CaseListe"
...
#    j = 0 #On démarre à l'index 0 (A1)
#    for j in range (len(Grille1)):
#        if Grille2[j][0] == CasePlayer1[Coord]: #Grille2[j][0] = Coord de la "CaseListe"
...
#    while i <= NbCase:
#        VariableBPB = Grille2[IndexCase][1] #Grille2[IndexCase][1] = BPB de la "CaseListe"
#        #print("Case " + str(i))        
#        #print(IndexCase)
#        #print(VariableBPB)
#        if VariableBPB == 0: #on vérifie l'état de BPB
...
#                i = i+1
#                IndexCase = IndexCase+20 #Index suivant
#                VariableBPB = Grille2[IndexCase][1] #Variable BPB de case suivante
#            else:
#                i = i+1
#        else:
#            #print("bateau sur un emplacement déjà pris. \n Veuillez ressaisir")
...
#/!\: CETTE FONCTION EST PROVISOIREMENT DESACTIVE POUR FLUIDIFIER LE PROGRAMME
#def Verif_VariableBPB_in_Grille2_for_H():
#    #On globalise toutes les variables
#    global NbCase
#    global Grille2
#    global IndexCase
...
def Verification_Final_Grille1():
    ...
    #/!\ PARTIE TEST DESACTIVER POUR CAUSE DE BUGS /!\
    #--> DEVAIT AFFICHER LES DERNIERES CASES TESTE: PERMET DE DETECTER LES BUG EN CAS DE SORTIE NON PREVUS
    #Partie TEST (la suppression de la partie devra se faire une fois celle-ci inutile)
    #print("ListeCases (dans l'ordre du dessin)")
    #if dessus == True:
    #    if gauche == True:
    ...
    #if gauche == True:
    #    print(Grille1[j+1])
    #print("FIN DU TEST DE VERIFICATION")
    #print("\n")
    #FIN Partie TEST
