...
#Initialisation Pygame (pour le pygame.image.load)
import pygame
from pygame.locals import *
pygame.init()
pygame.font.init()
fenetre = pygame.display.set_mode((1200, 900)) #obligé d'initialiser une fenêtre pour faire fonctionner le pygame.image.load
